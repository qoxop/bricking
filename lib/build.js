...
const buildHtml = (options) => {
    ...
    if (!isRemote) {
        sdkEntry = path_1.default.resolve(cdn, sdkEntry);
        systemjs = path_1.default.resolve(cdn, systemjs);
    ...
    if (realTime) { // 实时 SDK 模块
        // sdkEntry json 
        const combineCode = (0, build_sdk_1.REAL_TIME_CODE)(sdkEntry, path_1.default.resolve(cdn, appEntry));
        ...
        fs_1.default.writeFileSync(path_1.default.resolve(output, truesdkEntry), combineCode);
        const sdkScript = document.createElement('script');
        sdkScript.src = path_1.default.resolve(cdn, truesdkEntry);
