...
function loadConfig(config) {
    if (config) {
        if (!fs_1.default.existsSync(config)) {
            config = path_1.default.resolve(process.cwd(), config);
        }
...
class PostcssLoader extends types_1.Loader {
    ...
    async process(chunk, context) {
        ...
        console.log(path_1.default.resolve(output, assetsRelative));
        console.log(path_1.default.resolve(output, path_1.default.parse(context.id).base));
        // 处理配置对象
        const postcssOptions = {
            ...othersOptions,
            ...(config.options || {}),
            to: path_1.default.resolve(output, path_1.default.parse(context.id).base),
            from: context.id,
        };
        ...
        code = `import $__inject_styles from "/Users/zhangjiwei/Desktop/github/mf-build/lib/runtimes/inject-style.js";\n` + code;
