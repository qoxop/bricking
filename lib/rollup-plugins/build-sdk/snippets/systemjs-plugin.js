(function (g) {
    var import_maps = {}, dynamic_module_maps = {}, orgResolve = System.constructor.prototype.resolve, orgInstantiate = System.constructor.prototype.instantiate, cssLinkModulePattern = /^___INJECT_STYLE_LINK___/;
    ...
    System.constructor.prototype.resolve = function (id, parentURL) {
        if (import_maps[id])
            return orgResolve.call(this, import_maps[id], parentURL);
        if (dynamic_module_maps[id] || cssLinkModulePattern.test(id))
            return id;
