...
exports.InputName = path_1.default.join(process.cwd(), `./rumtime-systemjs-sdk.js`);
...
function default_1(options) {
    ...
    return {
        ...
        async generateBundle(_, bundle) {
            const systemjs_code = fs_1.default.readFileSync(require.resolve('systemjs/dist/system.js'), { encoding: 'utf8' });
